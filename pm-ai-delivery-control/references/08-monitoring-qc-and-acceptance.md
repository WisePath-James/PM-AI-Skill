...
```
1. 完整性检查 → 2. Baseline and Scope Audit → 3. 验收条件核对 → 4. 回归检查 → 5. 质量评级 → 6. 审查结论
```
...
### Step 2：Baseline and Scope Audit

- [ ] 已检查 Coder modified files
- [ ] modified files 均在工作包允许范围内
- [ ] 未修改 PM baseline 文件
- [ ] 已检查 git diff / 或说明无法检查
